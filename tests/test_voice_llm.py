...
class TestVoiceLLM:
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_init_creates_all_components(self, mock_makedirs, mock_chain_fn,
                                          mock_client, mock_recorder, mock_player):
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_transcribe_speech(self, mock_makedirs, mock_chain_fn, mock_client_cls,
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_generate_response(self, mock_makedirs, mock_chain_fn, mock_client,
                                mock_recorder, mock_player):
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_generate_response_error(self, mock_makedirs, mock_chain_fn, mock_client,
                                      mock_recorder, mock_player):
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_synthesize_speech(self, mock_makedirs, mock_chain_fn, mock_client_cls,
                                mock_recorder, mock_player):
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_process_text_input(self, mock_makedirs, mock_chain_fn, mock_client_cls,
                                 mock_recorder, mock_player):
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_process_audio_upload(self, mock_makedirs, mock_chain_fn, mock_client_cls,
                                   mock_recorder, mock_player):
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_process_audio_upload_transcription_fails(self, mock_makedirs, mock_chain_fn,
    ...
    @patch("src.voice_llm.get_conversation_chain")
    @patch("src.voice_llm.os.makedirs")
    def test_close(self, mock_makedirs, mock_chain_fn, mock_client,
